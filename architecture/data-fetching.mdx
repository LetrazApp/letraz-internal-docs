...
## Using Prefetched Data with Hydration in Next.js App Router and TanStack Query
...
For more details, refer to the [TanStack Query documentation](https://tanstack.com/query), [Next.js App Router docs](https://nextjs.org/docs/app) and [Repo](https://github.com/sahilverma-dev/tanstack-query-nextjs14-example)
